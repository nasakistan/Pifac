...
| `SearchSteps` | Targeting methods | [`TargetSearchSteps`](#targetsearchsteps) | The selector types to use for identifying the element. It can be set to any combination of Strict selector, Fuzzy selector, or Image. Default: `TargetSearchSteps.None`. |
